<template>
  <el-form ref="form" :model="formData" :rules="rules" label-width="100px" :size="defaultFormItemSize" label-position="right" @submit.native.prevent>
    <el-row :gutter="20" class="full-width-input">
      ...
      <el-col :span="12">
        <el-form-item label="权限字名称" prop="showName">
          <el-input v-model="formData.showName" placeholder="权限字名称" clearable maxlength="30"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
