<template>
  <div style="position: relative;">
    <el-form ref="formSysOperationLog" :model="formSysOperationLog" label-width="80px" :size="defaultFormItemSize" label-position="right" @submit.native.prevent>
    ...
    <table-box ref="teacher" :data="formSysOperationLog.operationLog.impl.dataList"
      :size="defaultFormItemSize" :hasExtend="false"
      header-cell-class-name="table-header-gray"
      @sort-change="formSysOperationLog.operationLog.impl.onSortChange"
      @refresh="refreshFormOperationType(true)" :seq-config="{startIndex: ((formSysOperationLog.operationLog.impl.currentPage - 1) * formSysOperationLog.operationLog.impl.pageSize)}"
    >
      <vxe-column title="序号" type="seq" width="55px" :index="formSysOperationLog.operationLog.impl.getTableIndex" />
