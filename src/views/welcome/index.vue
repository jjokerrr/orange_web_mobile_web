    ...
    <el-row type="flex">
      ...
      <el-card class="box-card" style="min-width: 450px; margin-left: 20px;" shadow="never" :body-style="{padding: '0px 20px'}">
        ...
        <div class="item">
          ...
          <a href="http://demo.orangeforms.com/visualization" target="_blank">http://demo.orangeforms.com/visualization</a>
        </div>
        <el-divider></el-divider>
        <div class="item">
          <span style="width: 120px;">租户管理</span>
          <a href="http://tenantadmin.orangeforms.com/" target="_blank">http://tenantadmin.orangeforms.com/</a>
        </div>
        <el-divider></el-divider>
        <div class="item">
          <span style="width: 120px;">租户运营</span>
          <a href="http://tenant.orangeforms.com/" target="_blank">http://tenant.orangeforms.com/</a>
        </div>
        <el-divider></el-divider>
        <div class="item">
        ...
        <div style="width: 100%; text-align: center; padding: 10px;">
          <img src="../../assets/img/orange-group4.png" />
        </div>
        -->
      </el-card>
    </el-row>
