...
export default {
  ...
  mounted() {
    ...
    this.diagramType = this.flowEntryInfo?.diagramType || this.DiagramType.ORDINARY;
    this.createNewDiagram(this.value).then(() => {
      this.loaded = true
    });
  ...
  methods: {
    ...
    async createNewDiagram(xml) {
      ...
      let xmlString = xml || DefaultEmptyXML(newId, newName, this.prefix, this.diagramType);
      try {
