<template>
  <el-tabs class="properties-panel" v-model="activeName" :style="{ width: `430px` }">
    ...
    <el-tab-pane label="变量设置" name="attributeSet" v-if="formVisible">
      <div class="panel-label" slot="label">变量设置</div>
      <div class="process-panel__container">
        <div v-if="formVisible" key="form">
          <div class="panel-title">
            变量
          ...
          <element-form v-if="activeName === 'attributeSet'" :id="elementId" :type="elementType" :tabType="activeName" :useVariableMap="useVariableMap" :entryId="entryId" ref="elementForm"/>
        </div>
      </div>
    </el-tab-pane>
