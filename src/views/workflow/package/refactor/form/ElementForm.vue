      ...
      <el-table :data="fieldList" :size="defaultFormItemSize" max-height="240" border fit>
        ...
        <el-table-column label="操作" width="90px">
          <template slot-scope="{ row, $index }">
            ...
            <el-button :size="defaultFormItemSize" type="text" @click="removeField(row, $index)">删除</el-button>
          </template>
        </el-table-column>
        <template slot="empty">
        ...
        <el-table :data="fieldEnumList" :size="defaultFormItemSize" key="enum-table" max-height="240" border fit>
          ...
          <el-table-column label="操作" width="90px">
            <template slot-scope="{ row, $index }">
              ...
              <!-- <el-divider direction="vertical" /> -->
              <el-button :size="defaultFormItemSize" type="text" @click="removeFieldOptionItem(row, $index, 'enum')">删除</el-button>
            </template>
          </el-table-column>
          <template slot="empty">
            <div class="table-empty unified-font">
      ...
      <el-table :data="fieldConstraintsList" :size="defaultFormItemSize" key="validation-table" max-height="240" border fit>
        ...
        <el-table-column label="操作" width="90px">
          <template slot-scope="{ row, $index }">
            ...
            <!-- <el-divider direction="vertical" /> -->
            <el-button :size="defaultFormItemSize" type="text" @click="removeFieldOptionItem(row, $index, 'constraint')">删除</el-button>
          </template>
        </el-table-column>
        <template slot="empty">
          <div class="table-empty unified-font">
      ...
      <el-table :data="fieldPropertiesList" :size="defaultFormItemSize" key="property-table" max-height="240" border fit>
        ...
        <el-table-column label="操作" width="90px">
          <template slot-scope="{ row, $index }">
            ...
            <!-- <el-divider direction="vertical" /> -->
            <el-button :size="defaultFormItemSize" type="text" @click="removeFieldOptionItem(row, $index, 'property')">删除</el-button>
          </template>
        </el-table-column>
        <template slot="empty">
          <div class="table-empty unified-font">
