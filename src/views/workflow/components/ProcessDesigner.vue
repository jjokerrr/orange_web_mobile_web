<template>
  <div class="process-design" style="display: flex; height: 100%;">
    <MyProcessDesigner
      ...
      @save="onSaveProcess"
    />
    <MyProcessPenal :key="`penal-${reloadIndex}`" :bpmn-modeler="modeler" :prefix="controlForm.prefix" :width="600" :useVariableMap="useVariableMap" :entryId="entryId" class="process-panel" />
  </div>
</template>
