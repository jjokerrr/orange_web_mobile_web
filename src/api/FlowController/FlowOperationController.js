export default class FlowOperationController {
  ...
  // 获取办理表单的数据显示权限
  static flowVariableDisplayInfo (sender, params, axiosOption, httpOption) {
    return sender.doUrl('/admin/flow/flowOperation/flowVariableDisplayInfo', 'get', params, axiosOption, httpOption);
  }
  // 获取在线表单工作流草稿数据
