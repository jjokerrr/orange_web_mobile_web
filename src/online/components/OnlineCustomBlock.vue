          ...
          <template v-if="Array.isArray(value) && value.length > 0">
            ...
            >
              ...
              >
                ...
                <div v-else-if="subWidget.widgetType === SysCustomWidgetType.CellGroup"
                  :style="{
                ...
                <OnlineCustomWidget
                  ...
                  @widgetClick="onWidgetClick"
                />
                <OnlineCustomImageCard v-else-if="subWidget.widgetType === SysCustomWidgetType.ImageCard"
                  :ref="subWidget.variableName"
                  :widget="subWidget"
                  :isEdit="isEdit"
                  :style="{'margin-bottom': (subWidget.props.paddingBottom || 0) + 'px'}"
                  @widgetClick="onWidgetClick"
                />
                <OnlineCustomQueryList v-else-if="subWidget.widgetType === SysCustomWidgetType.QueryList"
                  :widget="subWidget"
                  :isEdit="isEdit"
                  @widgetClick="onWidgetClick"
                />
                <OnlineCustomBaseList v-else-if="subWidget.widgetType === SysCustomWidgetType.List"
                  :widget="subWidget"
                  :isEdit="isEdit"
                  @widgetClick="onWidgetClick"
                />
                <component :is="form().mode === 'pc' ? 'el-form-item' : 'div'" v-else :label="subWidget.showName" inset
                  :prop="subWidget.propString" :class="{'mobile-item': form().mode === 'mobile'}"
